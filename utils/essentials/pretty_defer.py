...
LOADING_EMOJI = Emojis.orange_loading
CHECK_EMOJI = Emojis.orange_check
...
async def pretty_defer(
    ...
    content: str = "Please wait while Monika thinks...",
    embed: discord.Embed | None = None,
    ephemeral: bool = True,
):
    """
    Fully safe Monika loader for interactions.
...
async def pretty_error(
    ...
    """
    Standalone ephemeral error sender for Monika.
    - Always ephemeral.
    - Uses Monika's error emoji.
